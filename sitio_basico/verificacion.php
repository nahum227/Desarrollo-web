...
if(isset($_POST['enviar'])){
       ...
       verificar_datos($username,$password,$nombre,$apellido, $deportista);
       
}

//funcion para verificar si el username ingresado ya esta registrado en el archivo users.txt
        function verificar_datos($username_ing, $password_ing, $nombre_ing, $apellido_ing, $deportista_ing){  
                ...
                foreach($datos as $dato){
                        ...
                        list($id, $stored_user, $stored_pass, $first_name, $last_name, $deportista) = explode(":", $dato);  
